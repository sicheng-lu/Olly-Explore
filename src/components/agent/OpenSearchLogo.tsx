interface OpenSearchLogoProps {
  size?: number;
}

export function OpenSearchLogo({ size = 32 }: OpenSearchLogoProps) {
  return (
    <div className="animate-opensearch-pulse" style={{ width: size, height: size }}>
      <svg
