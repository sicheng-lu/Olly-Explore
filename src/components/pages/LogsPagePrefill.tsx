...
interface LogsPagePrefillProps {
  logEntries: LogEntry[];
}

export function LogsPagePrefill({ logEntries }: LogsPagePrefillProps) {
  ...
  return (
    <div data-testid="logs-prefill" className="flex h-full min-h-[500px] gap-0 rounded-lg overflow-hidden border border-oui-lightest-shade">
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col bg-white">
        ...
        <div className="flex items-center gap-3 px-4 py-2 border-b border-oui-lightest-shade">
          <span className="text-xs font-semibold text-oui-darkest-shade">
            Results ({logEntries.length}/{logEntries.length})
          </span>
